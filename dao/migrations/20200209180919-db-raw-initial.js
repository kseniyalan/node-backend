...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    CREATE TYPE "public"."enum_sessions_type" AS ENUM('manager');
    CREATE TYPE "public"."enum_sessions_status" AS ENUM('ENABLED', 'DISABLED', 'PENDING');
    CREATE TABLE IF NOT EXISTS "sessions" ("id" SERIAL, "type" "public"."enum_sessions_type" NOT NULL, "status" "public"."enum_sessions_status" NOT NULL, "token" TEXT NOT NULL, "last_update" TIMESTAMP WITH TIME ZONE NOT NULL, "manager_id" INTEGER REFERENCES "managers" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("id"));
